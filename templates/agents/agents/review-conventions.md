...
- **The project's own convention docs**: the primary, authoritative rules. `AGENTS.md` says where they live and which area each governs; the doc for the changed file's area applies, plus any repo-wide one. Weight these first. If the project documents no conventions, say so and report almost nothing rather than inventing rules.
