...
The domain language lives in one file, the project's glossary (the project map in `AGENTS.md` says where). No `CONTEXT.md` or `CONTEXT-MAP.md` beside it, and no per-context glossaries: every term goes in that one table.
